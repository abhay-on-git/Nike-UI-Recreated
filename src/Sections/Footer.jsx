      ...
      flex-wrap max-lg:flex-col ">
        <div className="flex flex-col items-start">
         ...
         text-white-400 sm:max-w-sm">
          Get shoes ready for the
          new term at your nearest Nike store.
          Find your perfeeect size In store.
          Get rewards
         </p>
         ...
         gap-55 mt-8">
           {socialMedia.map((icon)=>(
              ...
              items-center w-12 h-12 bg-white rounded-full mx-2">
       ...
       lg:gap-10 gap-20 flex-wrap">
          {footerLinks.map((section)=>(
             <div key={section}>
              ...
              font-montserrat text-2xl leading-normal mb-6 font-medium">
              {section.title}
              </h4>
              <ul>
